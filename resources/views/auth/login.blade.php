...
<body class="login_page">
    <div class="login_page_wrapper">
        <div class="md-card" id="login_card">
            ...
            <div class="md-card-content large-padding uk-position-relative" id="login_help" style="display: none">
                ...
                <p>If your password still isn’t working, it’s time to <a href="{{ route('password.request') }}" id="password_reset_show">reset your password</a>.</p>
            </div>
    ...
    <script src="{{ url('assets/js/pages/components_notifications.min.js') }}"></script>
        ...
        @if (count($errors) > 0)
            $(function () {
                @foreach ($errors->all() as $error)
                    UIkit.notify({
                        message: "<a href='#' class='notify-action'><i class='material-icons'>close</i></a> {{ $error }}",
                        status: 'danger',
                        timeout: 5000,
                        group: null,
                        pos: 'bottom-center'
